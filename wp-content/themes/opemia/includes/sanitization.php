 ...
 */
function opemia_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function opemia_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function opemia_sanitize_html( $html ) {
 ...
 */
function opemia_sanitize_image( $image, $setting ) {
 ...
 */
function opemia_sanitize_nohtml( $nohtml ) {
 ...
 */
function opemia_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function opemia_sanitize_number_range( $number, $setting ) {
 ...
 */
function opemia_sanitize_select( $input, $setting ) {
 ...
 */
function opemia_sanitize_url( $url ) {
	return esc_url_raw( $url );
}

/* Sanitization Text*/
function opemia_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function opemia_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}